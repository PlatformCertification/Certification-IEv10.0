...
The main purpose of platform certification plugin is apply the accuracy error correction for device, interface, topo and IPs data exist in NetBrain main DB which generated by NetBrain built-in discover and benchmark logic. 
