...
| diagnosis_inputs.inputs.input_datas.common_table_name | String | Represent the name of the current common which will be generated per all input_datas in current diagnosis.| 
